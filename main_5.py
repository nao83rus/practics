...
class Note:
    def __init__(self, date, description, work_time): # start_time, end_time,
        self.date = date
...
class MainApp(App):
    ...
    def update_notes(self):
        ...
        if self.current_technique:
            ...
            for note in self.notes[self.current_technique]:
                ...
                delete_button = Button(text="X", size_hint_x=None, width=50)
        ...
        if self.current_technique:
            ...
            with open(filename, "w", encoding="utf-8") as file:
                for note in self.notes[self.current_technique]:
                    ...
                    file.write(f"{note.date};{note.description};{note.work_time.seconds}\n")
    ...
    def export_data(self, instance):
        ...
        self.save_data()
        print("Данные экспортированы в файл data.json")

    def import_data(self, instance):
        """Импорт данных из файла."""
        self.load_data()
        print("Данные импортированы из файла data.json")
            ...
            if os.path.exists(filename):
                with open(filename, "r", encoding="utf-8") as file:
                    ...
                    for line in file:
                        ...
                        date, description, work_time_seconds = line.strip().split(";")
                        ...
                        self.notes[technique].append(Note(date, description, work_time))
